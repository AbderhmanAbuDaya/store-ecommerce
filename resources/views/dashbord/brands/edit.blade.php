                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                            ...
                                            <input name="edit" value="{{$brand -> id}}" type="hidden">
                                            @isset($brand)
                                               @foreach($brand->translations as $tran)
                                            ...
                                            <div class="form-group">
                                                <label class="px-1"> صوره الماركة  </label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($brand ->is_active == 'active')checked @endif/>
